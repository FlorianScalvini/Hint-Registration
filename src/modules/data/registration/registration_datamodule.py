...
class RegistrationDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.train_subjects = subjects[:train_size]
        self.val_subjects = subjects[train_size:train_size + val_size]
        self.test_subjects = subjects[train_size + val_size:]
    ...
    def test_dataloader(self) -> TRAIN_DATALOADERS:
        ...
        return tio.SubjectsLoader(test_dataset, batch_size=self.batch_size,
                                  num_workers=self.num_workers,
                                  persistent_workers=True)