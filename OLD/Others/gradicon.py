...
class GradIcon(RegistrationModule):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--mode', help='Unigradicon or Multigradicon', type=str, required=False, default='multigradicon')
    ...
    main(source_subject, target_subject, mode=args.mode)